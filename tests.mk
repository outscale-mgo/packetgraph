...
tests_udp_switch_DIR = tests/udp-switch
tests_udp_switch_SOURCES = \
	$(tests_udp_switch_DIR)/tests.c
tests_udp_switch_OBJECTS = $(tests_udp_switch_SOURCES:.c=.o)
...
test: dev tests-all-build antispoof core diode rxtx pmtud firewall nic print queue switch vtep tap thread integration udp-switch vhost accumulator
	@echo "tests ended"

tests_compile: dev tests-antispoof tests-core tests-diode tests-rxtx tests-pmtud tests-integration tests-nic tests-print tests-queue tests-switch tests-vhost tests-vtep tests-tap tests-thread tests-udp-switch tests-firewall tests-accumulator
...
tests-udp-switch: dev $(tests_udp_switch_OBJECTS)
	$(CC) $(tests_CFLAGS) $(PG_ASAN_CFLAGS) $(tests_udp_switch_OBJECTS) $(tests_LIBS) -o $@

$(tests_udp_switch_OBJECTS): %.o : %.c
	$(CC) -c $(tests_CFLAGS) $(PG_ASAN_CFLAGS) $< -o $@
