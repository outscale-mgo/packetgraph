...
static void test_vtep_lifetime(void)
{
	...
	struct ether_addr mac[] = {
		...
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc1}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc2}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc3}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc4}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc6}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc7}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc8}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc9}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcA}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcB}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcC}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcD}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcE}},
		{{0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xcF}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc0}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc1}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc2}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc3}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc4}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc5}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc6}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc7}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc8}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xc9}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcA}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcB}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcC}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcD}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcE}},
		{{0xc0, 0xc1, 0xb2, 0xc3, 0xc4, 0xcF}},
	};
	...
	PG_FOREACH_BIT(mask, j) {
		...
		ether_addr_copy(&mac[p], &eth_hdr.s_addr);
		ether_addr_copy(&mac[p + 1], &eth_hdr.d_addr);
	...
	for (uint64_t i, bit, tmp_mask = mask; tmp_mask;) {
		...
		struct pg_mac_table *mtd = pg_vtep4_mac_to_dst(vtep, pid);
		union pg_mac pgm = {.rte_addr = mac[pid]};
	...
	for (uint64_t c = 10000; c; --c) {
		for (uint64_t i = 0; i < 8; ++i) {
			uint64_t bit = 1 << i;
			pg_packets_prepend_vxlan(pkts, bit, 0);
			pg_packets_prepend_udp(pkts, bit, 1000, PG_VTEP_DST_PORT,
					       pkt_len);
			pg_packets_prepend_ipv4(pkts, bit, 0x000000EE,
						0x000000E1, pkt_len + sizeof(struct headers_v4),
						17);
	...
	/* check mac_to_dst know every mac */
